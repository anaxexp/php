...
- [PHP Docker Container Images](#php-docker-container-images)
...
* `7`, `7.2`, `latest` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `7.1` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `7.0` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `5`, `5.6` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/5.6/Dockerfile)
* `5.3` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/5.3/Dockerfile)
* `7-dev`, `7.2-dev` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `7.1-dev` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `7.0-dev` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `5-dev`, `5.6-dev` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/5.6/Dockerfile)
* `5.3-dev` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/5.3/Dockerfile)
* `7-dev-macos`, `7.2-dev-macos` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `7.1-dev-macos` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `7.0-dev-macos` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `5-dev-macos`, `5.6-dev-macos` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/5.6/Dockerfile)
* `5.3-dev-macos` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/5.3/Dockerfile)
* `7-debug`, `7.2-debug` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `7.1-debug` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `7.0-debug` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/7/Dockerfile)
* `5-debug`, `5.6-debug` [_(Dockerfile)_](https://github.com/anaxexp/php/tree/master/5.6/Dockerfile)
...
[7.x xdebug]: https://github.com/anaxexp/php/tree/master/7/templates/docker-php-ext-xdebug.ini.tpl
[5.6 xdebug]: https://github.com/anaxexp/php/tree/master/5.6/templates/docker-php-ext-xdebug.ini.tpl

[7.2 sessions]: https://github.com/anaxexp/php/tree/master/7/templates/docker-php-7.2.ini.tpl
[7.1 sessions]: https://github.com/anaxexp/php/tree/master/7/templates/docker-php-7.1.ini.tpl
[7.0 sessions]: https://github.com/anaxexp/php/tree/master/7/templates/docker-php-7.0.ini.tpl
[5.6 sessions]: https://github.com/anaxexp/php/tree/master/5.6/templates/docker-php.ini.tpl
...
[latest]: https://github.com/anaxexp/pecl-php-uploadprogress/releases/tag/latest
...
* `sudo` allowed for all commands for `anaxexp` user
...
Default container user is `anaxexp:anaxexp` (UID/GID `1000`). PHP-FPM runs from `www-data:www-data` user (UID/GID `82`) by default. User `anaxexp` is a part of `www-data` group.

Codebase volume `$APP_ROOT` (`/var/www/html`) owned by `anaxexp:anaxexp`. Files volume `$FILES_DIR` (`/mnt/files`) owned by `www-data:www-data` with `775` mode.

See https://github.com/anaxexp/php/issues/22 for more details.
